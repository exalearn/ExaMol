...
from examol.score.rdkit import RDKitScorer, make_gpr_model, FingerprintTransformer
...
run_dir = my_path / ('run' if multi_fidelity else 'run-single')
...
solution = MultiFidelityActiveLearning(
    selector=ExpectedImprovement(200, maximize=True, epsilon=0.1),
